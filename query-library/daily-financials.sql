/*
description: this query pulls transaction data for core remittance (excluding Remitly Business (also called SMB) and Rewire (sent from Israel)), and calculates various metrics related to remittance revenue and profit.

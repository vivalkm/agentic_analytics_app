...
export const MANAGED_KEYS: ManagedKey[] = [
  ...
  { key: 'TRINO_HOST', label: 'Trino Host', group: 'trino', secret: false, placeholder: 'https://lakehouse-router-prod.us-west-2.remitly.com' },
  { key: 'TRINO_PORT', label: 'Trino Port', group: 'trino', secret: false, placeholder: '443' },
  { key: 'TRINO_CATALOG', label: 'Catalog', group: 'trino', secret: false, placeholder: 'lakehouse' },
